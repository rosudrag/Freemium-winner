...
class CallTest(unittest.TestCase):
    ...
    def test_repr(self):
        ...
        self.assertEqual(repr(call().Run), 'call().foo')
        self.assertEqual(repr(call(1).Run.bar(a=3).bing),
                         'call().foo.bar().bing')
        self.assertEqual(
            repr(call().Run(1, 2, a=3)),
            "call().foo(1, 2, a=3)"
        )
        self.assertEqual(repr(call()()), "call()()")
    ...
    def test_call_list(self):
        ...
        mock = MagicMock()
        int(mock(1).method(2)(3).Run.bar.baz(4)(5))
        kall = call(1).method(2)(3).Run.bar.baz(4)(5).__int__()
...
class SpecSignatureTest(unittest.TestCase):
    ...
    def test_create_autospec_unbound_methods(self):
        ...
        instance = klass()
        self.assertRaises(TypeError, instance.Run, 1)

        # Note: no type checking on the "self" parameter
        klass.Run(1)
        klass.Run.assert_called_with(1)
        self.assertRaises(TypeError, klass.Run)
    ...
    def test_spec_as_list(self):
        ...
        mock.Run.append(3)
        mock.Run.append.assert_called_with(3)
        self.assertRaises(AttributeError, getattr, mock.Run, 'foo')
    ...
    def test_recursive(self):
        ...
        self.assertIsNot(mock.Run, mock.bar)
        mock.Run.lower()
    ...
    def test_create_autospec_none(self):
        ...
        none.Run()
        none.Run.assert_called_once_with()
