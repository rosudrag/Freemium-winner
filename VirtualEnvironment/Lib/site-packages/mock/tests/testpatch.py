...
class PatchTest(unittest.TestCase):
    ...
    def test_patch_keyword_args(self):
        ...
        self.assertEqual(mock.Run.bar(), 33)
        self.assertIsInstance(mock.Run, MagicMock)
    ...
    def test_autospec(self):
        ...
        def _test2(mock):
            ...
            mock.Run.lower()
            mock.Run.lower.assert_called_with()
            self.assertRaises(AttributeError, getattr, mock.Run, 'bar')
